...
def verify_linksys_e1200_fuzz(profile_path: str, seed_path: str, iterations: int = 10):
    print(f"[*] Loading Linksys E1200 profile from {profile_path}...")
    ...
    qemu_path = "/home/webfuzz/Documents/qemu/build/qemu-mipsel"
    ...
    output_dir = "tests/fuzz_output_linksys"
...
if __name__ == "__main__":
    profile = "fuzzing/config/targets/linksys_e1200.json"
    seed = "tests/seeds/Linksys_E1200/linksys_e1200_seed.bin"
    ...
    verify_linksys_e1200_fuzz(profile, seed, iterations=100)
