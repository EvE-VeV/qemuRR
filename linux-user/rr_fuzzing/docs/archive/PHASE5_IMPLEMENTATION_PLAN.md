...
#### [MODIFY] [rr_record.c](file:///home/webfuzz/Documents/qemu/linux-user/rr_fuzzing/src/engine/rr_record.c)
...
#### [MODIFY] [rr_main.c](file:///home/webfuzz/Documents/qemu/linux-user/rr_fuzzing/src/core/rr_main.c)
- **Header Refactor**: Include `user-internals.h` to resolve `thread_cpu` visibility for TB flushing.

#### [MODIFY] [rr_replay.c](file:///home/webfuzz/Documents/qemu/linux-user/rr_fuzzing/src/engine/rr_replay.c)
